...
// Add interface for classroom data
interface Classroom {
  id: string;
  class_name: string;
}
  ...
  useEffect(() => {
    const fetchClassrooms = async () => {
      ...
      if (open) {
        setIsLoading(true);
        try {
          const response = await Request.Get('/api/teacher/class');
        ...
        {step === 1 && (
          <div className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="classroom">Student Name</Label>
              <Select
